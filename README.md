...
Heatmap_card_all.R - Heatmap des résistances pour un ensemble d'échantillons blastés contre card. Input = dossier contenant les tsv et entêtes séparées de la base de données.  

Heatmap_bacmet_all.R - Heatmap des résistances pour un ensemble d'échantillons blastés contre bacmet. Input = dossier contenant les tsv et entêtes séparées de la base de données.  

![Heatmap donné par Heatmap_card_all.R](Images/Heatmap_Card.png)

![Heatmap donné par Heatmap_bacmet_all.R](Images/Heatmap_Card.png)
...
![Extrait d'un tableau donné par Tableau_Plasmide.R](Images/Tableau_Plasmide_Card.png)
...
![Barplots donnés par Barplot_genre.R](Images/Barplot_genre.png)
